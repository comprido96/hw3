...
class RL_Trainer(object):
    ...
    def run_training_loop(self, n_iter, collect_policy, eval_policy,
        ...
        # for plotting:
        envsteps, avg_returns, best_returns = [], [], []
        ...
        for itr in range(n_iter):
            ...
            if self.logvideo or self.logmetrics:
                ...
                if isinstance(self.agent, DQNAgent):
                    envsteps_so_far, avg_return, best_return = self.perform_dqn_logging(all_logs)
                    envsteps.append(envsteps)
        ...
        return envsteps, avg_returns, best_returns    
    ...
    def perform_dqn_logging(self, all_logs):
        ...
        return logs["Train_EnvstepsSoFar"], np.mean(self.mean_episode_reward), np.mean(self.best_mean_episode_reward)
